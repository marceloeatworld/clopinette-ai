...
export async function compressContext(
  ...
  // The recent window must not start on a tool result whose tool call was
  // compressed away — providers reject an orphaned tool message. Advance the
  // cut until it lands on a non-tool message.
